   ...
   (
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        Realiza tus operaciones desde cualquier lugar, <br className='sm:block hidden'/>
        de una manera facil y segura.
        </h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Descarga nuestra aplicación móvil disponible para iOS y Android.
        </p>
